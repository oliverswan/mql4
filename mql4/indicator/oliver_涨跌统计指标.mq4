...
int start()
  {
//----
if (TimeCurrent()>D'2018.02.28') //这里设定过期时间
...
if(iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i+1],TIME_DATE)+" "+亚洲盘始))-1)<
StrToTime(TimeToStr(Time[i+1],TIME_DATE)+" "+亚洲盘始)-30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i+1],TIME_DATE)+" "+亚洲盘始))-1)>
StrToTime(TimeToStr(Time[i+1],TIME_DATE)+" "+亚洲盘始)+30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)))<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)-30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)))>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)+30*60
...
-iClose(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)));
if(iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘始))-1)<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘始)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘始))-1)>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘始)+30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)))<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)))>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+亚洲盘终)+30*60
...
if(iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘始))-1)<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘始)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘始))-1)>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘始)+30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘终)))<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘终)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘终)))>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+欧洲盘终)+30*60
...
if(iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘始))-1)<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘始)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘始))-1)>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘始)+30*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘终)))<
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘终)-60*60
||iTime(NULL,30,iBarShift(NULL,30,StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘终)))>
StrToTime(TimeToStr(Time[i],TIME_DATE)+" "+美洲盘终)+30*60
